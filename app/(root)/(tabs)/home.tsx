        ...
        ListHeaderComponent={()=>(
          <>
             <View className='flex-row justify-between items-center py-5'>
                 ...
                 <TouchableOpacity onPress={handleSignOut} className='items-center justify-center bg-white rounded-full w-10 h-10'>
                    <Image source={icons.out} className='w-5 h-5' resizeMode='contain'/>
                 </TouchableOpacity>
             </View>
